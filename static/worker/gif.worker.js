!(function (t) {
		...
		(r = i(1)),
			(s = function (t) {
				...
				return (
					...
					0 === t.index ? e.writeHeader() : (e.firstFrame = !1),
					...
					t.canTransfer
						? ((o = (function () {
								var e, r, s, o;
								for (s = t.data, o = [], e = 0, r = s.length; e < r; e++)
	...
	function (t, e, i) {
		...
		(r.prototype.newPage = function () {
			...
			(s.prototype.ditherPixels = function (t, e) {
				...
				if (!t || !i[t]) throw 'Unknown dithering kernel: ' + t;
				var r = i[t],
					s = 0,
					o = this.height,
					n = this.width,
				...
				for (var l = 0; l < o; l++) {
					...
					for (var u = 1 == h ? 0 : n - 1, p = 1 == h ? n : 0; u !== p; u += h) {
						...
						var f = 3 * s,
							...
							y = a[f + 1],
							w = a[f + 2];
						(f = this.findClosestRGB(c, y, w)),
							(this.usedEntry[f] = !0),
							(this.indexedPixels[s] = f),
							(f *= 3);
						for (
							var d = this.colorTab[f],
								g = this.colorTab[f + 1],
								x = this.colorTab[f + 2],
								b = c - d,
								v = y - g,
			...
			(s.prototype.findClosestRGB = function (t, e, i, r) {
				...
				for (var s = 0, o = 16777216, n = this.colorTab.length, a = 0, h = 0; a < n; h++) {
					var l = t - (255 & this.colorTab[a++]),
						...
						f = l * l + u * u + p * p;
					(!r || this.usedEntry[h]) && f < o && ((o = f), (s = h));
				}
				return s;
			}),
	...
	function (t, e) {
		function i(t, e) {
			...
			function c() {
				for (var t = 0; t < s; t++)
					(z[t][0] >>= n), (z[t][1] >>= n), (z[t][2] >>= n), (z[t][3] = t);
			}
			...
			function v(t, e, i) {
				...
				for (r = 0; r < s; r++)
					(o = z[r]),
						(h =
							(Math.abs((0 | o[0]) - t) + Math.abs((0 | o[1]) - e) + Math.abs((0 | o[2]) - i)) | 0),
						h < w && ((w = h), (g = r)),
						(c = h - ((0 | R[r]) >> (a - n))),
						c < d && ((d = c), (x = r)),
						(y = U[r] >> u),
			...
			function m() {
				var t,
					...
					l = 0;
				for (t = 0; t < s; t++) {
					for (i = z[t], n = t, a = i[1], e = t + 1; e < s; e++)
						(r = z[e]), r[1] < a && ((n = e), (a = r[1]));
					if (
						((r = z[n]),
						t != n &&
							((e = r[0]),
				...
				for (E[h] = (l + o) >> 1, e = h + 1; e < 256; e++) E[e] = o;
			}
			function C(t, e, i) {
				(t = 0 | t), (e = 0 | e), (i = 0 | i);
			...
			function G() {
				for (var t = [], e = [], i = 0; i < s; i++) e[z[i][3]] = i;
				for (var r = 0, o = 0; o < s; o++) {
					var n = e[o];
					(t[r++] = z[n][0]), (t[r++] = z[n][1]), (t[r++] = z[n][2]);
				}
				return t;
			}
			var z, E, R, U, Q;
			...
			function d(t, e) {
				...
				if (
					((A > b || C) &&
						(C
							? ((b = y((n_bits = v))), (C = !1))
							: (++n_bits, (b = n_bits == s ? 1 << s : y(n_bits)))),
					t == m)
				) {
